defmodule JarmotionWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: JarmotionWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/jarmotion_web/templates",
        namespace: JarmotionWeb
      ...
      import JarmotionWeb.ErrorHelpers
      import JarmotionWeb.Gettext
      alias JarmotionWeb.Router.Helpers, as: Routes
    end
  end
